...
@section('title',  trans('global.create') . " " . trans('cruds.product.title'))
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-12">
                        <label class="required"
                               for="stock_minimum">{{ trans('cruds.product.fields.stock_minimum') }}</label>
                        <input class="form-control {{ $errors->has('stock_minimum') ? 'is-invalid' : '' }}"
                               type="number"
                               name="stock_minimum" id="stock_minimum" value="{{ old('stock_minimum', '0') }}" step="1"
                               required>
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control {{ $errors->has('price_buy') ? 'is-invalid' : '' }}" type="number"
                               name="price_buy" id="price_buy" value="{{ old('price_buy', '') }}" step="0.01" required>
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control {{ $errors->has('price_sell') ? 'is-invalid' : '' }}" type="number"
                               name="price_sell" id="price_sell" value="{{ old('price_sell', '') }}" step="0.01"
                               required>
                    ...
                    <div class="col-sm-12">
                        ...
                        <select class="form-control {{ $errors->has('packaging_unit') ? 'is-invalid' : '' }}"
                                name="packaging_unit" id="packaging_unit">
                            <option value
                                    disabled {{ old('packaging_unit', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                            @foreach(App\Models\Product::PACKAGING_UNIT_SELECT as $key => $label)
                                <option
                                    value="{{ $key }}" {{ old('packaging_unit', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div
                            class="needsclick dropzone form-control {{ $errors->has('featured_image') ? 'is-invalid' : '' }}"
                    ...
                    <div class="col-sm-12">
                        <label class="required"
                               for="product_code">{{ trans('cruds.product.fields.product_code') }}</label>
                        <input class="form-control {{ $errors->has('product_code') ? 'is-invalid' : '' }}" type="text"
                               name="product_code" id="product_code" value="{{ old('product_code', '') }}" required>
