...
$(function () {
    ...
    let dtOverrideGlobals = {
        ...
        dataTableClass = $('.datatable-Discounts'),
    ...
    $('.datatable-Discounts tbody').on('click', 'td:not(:first-child, :last-child)', (event) => {
        let row = table.row(event.currentTarget).data();
        window.location.href = '/admin/discounts/' + row.id;
    });

    $('.btn-create-new').on('click', function () {
        window.location.href = '/admin/discounts/create';
    });
});
