...
$(function () {
    ...
    let dtOverrideGlobals = {
        ...
        dataTableClass = $('.datatable-ArticleContent'),
    ...
    $('.datatable-ArticleContent tbody').on('click', 'td:not(:first-child, :last-child)', (event) => {
        let row = table.row(event.currentTarget).data();
        window.location.href = '/admin/article-contents/'+row.id;
    });

    $('.btn-create-new').on('click', function () {
        window.location.href = '/admin/article-contents/create';
    });
});
