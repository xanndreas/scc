...
$(function () {
    ...
    let dtOverrideGlobals = {
            ...
            columns: [
                ...
                {data: 'stock_minimum', name: 'stock_minimum'},
                {data: 'price_buy', name: 'price_buy'},
                {data: 'price_sell', name: 'price_sell'},
                {data: 'packaging_unit', name: 'packaging_unit'},
        ...
        dataTableClass = $('.datatable-Products'),
    ...
    $('.datatable-Products tbody').on('click', 'td:not(:first-child, :last-child)', (event) => {
