    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stock_minimum') ? 'is-invalid' : '' }}" type="number" name="stock_minimum" id="stock_minimum" value="{{ old('stock_minimum', '0') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_buy') ? 'is-invalid' : '' }}" type="number" name="price_buy" id="price_buy" value="{{ old('price_buy', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_sell') ? 'is-invalid' : '' }}" type="number" name="price_sell" id="price_sell" value="{{ old('price_sell', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('packaging_unit') ? 'is-invalid' : '' }}" name="packaging_unit" id="packaging_unit">
                    ...
                    @foreach(App\Models\Product::PACKAGING_UNIT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('packaging_unit', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
