...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#product_purchasing_details" role="tab" data-toggle="tab">
                {{ trans('cruds.purchasingDetail.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="product_purchasing_details">
            @includeIf('admin.products.relationships.productPurchasingDetails', ['purchasingDetails' => $product->productPurchasingDetails])
        </div>
    </div>
</div>
