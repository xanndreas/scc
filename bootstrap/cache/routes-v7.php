...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::udVNas5dXCSnsoua',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::hVYonsCv4VVo7tTO',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::2dC5SkqDkfG2dENQ',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/marketplaces/([^/]++)(?|(*:32)|(*:39)|(*:46)|(*:53))|/cas/(?|transaction/([^/]++)(*:89)|cart\\-(?|remove/([^/]++)(*:120)|change/([^/]++)(*:143)))|/blogs/([^/]++)(*:168)|/supplies/([^/]++)(*:194)|/password/reset/([^/]++)(*:226)|/admin/(?|p(?|ermissions/([^/]++)(?|(*:270)|/edit(*:283)|(*:291))|roducts/([^/]++)(?|(*:319)|/edit(*:332)|(*:340))|urchasings/(?|([^/]++)(*:371)|done/([^/]++)(*:392)))|roles/([^/]++)(?|(*:419)|/edit(*:432)|(*:440))|users/([^/]++)(?|(*:466)|/edit(*:479)|(*:487))|a(?|udit\\-logs/([^/]++)(*:519)|rticle\\-c(?|ontents/([^/]++)(?|(*:558)|/edit(*:571)|(*:579))|ategories/([^/]++)(?|(*:609)|/edit(*:622)|(*:630))))|c(?|ategories/([^/]++)(?|(*:666)|/edit(*:679)|(*:687))|ontacts/([^/]++)(?|(*:715)|/edit(*:728)|(*:736)))|s(?|ellings/([^/]++)(?|(*:769))|tock\\-opnames/([^/]++)(?|(*:803)|/edit(*:816)|(*:824))|upplies/([^/]++)(?|(*:852)|/edit(*:865)|(*:873)))|offers/(?|create/([^/]++)(*:908)|([^/]++)(?|(*:927)|/edit(*:940)|(*:948)))|inventories/(?|history/([^/]++)(*:989)|([^/]++)(*:1005))|transactions/(?|([^/]++)(*:1039)|export(*:1054))))/?$}sDu',
    ),
    3 => 
    array (
      32 => 
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'customers.cas.cart-remove',
          ),
          1 => 
          array (
            0 => 'product',
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'customers.cas.cart-change',
          ),
          1 => 
          array (
            0 => 'product',
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.purchasings.mark-done',
          ),
          1 => 
          array (
            0 => 'purchasing',
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.inventories.showByProduct',
          ),
          1 => 
          array (
            0 => 'product',
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.transactions.export',
          ),
          1 => 
          array (
          ),
  ...
  array (
    ...
    'customers.cas.cart-remove' => 
    array (
      'methods' => 
      array (
        0 => 'POST',
      ),
      'uri' => 'cas/cart-remove/{product}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\customer\\CustomerAreasController@cartRemove',
        'controller' => 'App\\Http\\Controllers\\customer\\CustomerAreasController@cartRemove',
        'as' => 'customers.cas.cart-remove',
        'namespace' => 'App\\Http\\Controllers\\customer',
        'prefix' => '',
        'where' => 
        array (
    ...
    'customers.cas.cart-change' => 
    array (
      'methods' => 
      array (
        0 => 'POST',
      ),
      'uri' => 'cas/cart-change/{product}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\customer\\CustomerAreasController@cartChange',
        'controller' => 'App\\Http\\Controllers\\customer\\CustomerAreasController@cartChange',
        'as' => 'customers.cas.cart-change',
        'namespace' => 'App\\Http\\Controllers\\customer',
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\admin\\HomeController@chartData',
        'controller' => 'App\\Http\\Controllers\\admin\\HomeController@chartData',
        'as' => 'admin.home.chart',
        'namespace' => 'App\\Http\\Controllers\\admin',
        'prefix' => '/admin',
        'where' => 
    ...
    'admin.purchasings.mark-done' => 
    array (
      'methods' => 
      array (
        0 => 'POST',
      ),
      'uri' => 'admin/purchasings/done/{purchasing}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\admin\\PurchasingController@markDone',
        'controller' => 'App\\Http\\Controllers\\admin\\PurchasingController@markDone',
        'as' => 'admin.purchasings.mark-done',
        'namespace' => 'App\\Http\\Controllers\\admin',
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    'admin.inventories.showByProduct' => 
    array (
      'methods' => 
      array (
        0 => 'GET',
      ...
      'uri' => 'admin/inventories/history/{product}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'as' => 'admin.inventories.showByProduct',
        'namespace' => 'App\\Http\\Controllers\\admin',
        'prefix' => '/admin',
        'where' => 
        array (
